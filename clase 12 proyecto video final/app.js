...
var express 		= 	require("express"),
	...
	passport.use(new LocalStrategy(function(username, password, done)
	{
		...
		var sql = "select idusuario, email, usuario, clave from users where usuario = '"+(username)+"'"; //VARIABLE QUE GUARDARÁ LA SENTENCIA SQL...
	...
	app.post("/index", rutas.crearComentario);
	//Para traer los comentarios de un video..
	app.post("/comentarios", rutas.listarComentarios);
	//Para guardar un video...
	app.post("/video", rutas.ingresarVideo);
	//Para listar videos...
	app.get("/video", rutas.listarVideos);
